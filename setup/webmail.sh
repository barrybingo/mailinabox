...
apt_install \
	dbconfig-common \
	php7.1-cli php7.1-sqlite php7.1-mcrypt php7.1-intl php7.1-json php7.1-common \
	php7.1-gd php7.1-pspell tinymce libjs-jquery libjs-jquery-mousewheel libmagic1 php7.1-mbstring
